...
Try {
	...
	[string]$appVendor = 'Microchip'
	[string]$appName = 'MPLABX IDE'
	[string]$appVersion = '4.20'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '3.7.0.1'
	[string]$appScriptDate = '07/17/2018'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Execute-Process -Path "certutil.exe" -Parameters "-f -addstore -enterprise TrustedPublisher `"$dirSupportFiles\mplabx.cer`""
		Execute-Process -Path "$dirSupportFiles\drivers\dpinst64.exe" -Parameters "/s" -WindowStyle "Hidden" -PassThru
		...
		Execute-Process -Path "MPLABX-v4.20-windows-installer.exe" -Parameters "--mode unattended"
		Execute-Process -Path "xc8-v2.00-full-install-windows-installer.exe" -Parameters "--mode unattended --netservername """
		...
		Remove-Item "$envCommonDesktop\MPLAB X IDE v4.20.lnk" -Force -Recurse
		Remove-Item "$envCommonDesktop\MPLAB X IPE v4.20.lnk" -Force -Recurse
		Remove-Item "$envCommonDesktop\MPLAB driver switcher.lnk" -Force -Recurse
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		# <Perform Uninstallation tasks here>
			Execute-Process -Path "C:\Program Files (x86)\Microchip\MPLABX\v4.20\Uninstall_MPLAB_X_IDE_v4.20.exe" -Parameters "--mode unattended"
			Execute-Process -Path "C:\Program Files (x86)\Microchip\xc8\v2.00\Uninstall-xc8-v2.00.exe" -Parameters "--mode unattended"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBbOdDIs9kQJP2P
# JBjouccJL+fT8wYaMKisL1QhTak5X6CCFFwwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg7+sC7wEa
# WYPCDSrjQka7nVJJVX3u+V97Lm+nkkTp8rEwDQYJKoZIhvcNAQEBBQAEggEAqJBV
# RkaFDsKQxdqCqMTlCPyTNBd1y752p5DguzAQmaGU5rIYDyXIBw9iici2uCY/k+NX
# F7NTEUnNbwNMv9AGSfjJAxdGE1CFz5sXh0lQ5/pLaIaTRifp27u25U4wma/HIINz
# xV+W/VULTu9vJN780v5RY9PTLPW3U0XtUdNcCxoClyVMYQEAc7MlFDpxV8wGvBSw
# +V2rg1DVE6QbkYVBAmZeP7mHeOB/VqWLi4dZwYu6ol1aTJDeTP10pezk8ZatB9EM
# 06IbLTxBMbxI9csB0ZRgB8Lga5k449gS1atCe98XE2aeVcxOt8oGHtpOsBQ9niaz
# NApnqSgPTa49v2hpsqGCAqIwggKeBgkqhkiG9w0BCQYxggKPMIICiwIBATBoMFIx
...
# CSqGSIb3DQEJBTEPFw0xODA3MTgyMDQzMTdaMCMGCSqGSIb3DQEJBDEWBBRxlvOY
# KPbMiWqin4d9FxyWykSRRzCBnQYLKoZIhvcNAQkQAgwxgY0wgYowgYcwgYQEFGO4
...
# ggEAq1Z8u7t2Vxaqpcg/TY1rPw4/wA0jk/jxvh3n01p0KWeXmWGWozVjxcv3NDH4
# NzonIVCBuC3YPmo5kPB4LDKdy/HHvrQS4GFJSEbZeBZmE1R5zA59KYG90pFRsVzL
# FjhvsHrTtCALE3ltaHLp+h+owsbHKMTPobIHjfPedYZVbKTtNokKBkrgFqPBkuyO
# VNAHYcSUsWEO/wHkTVCFur+VOfkCfFFuY0e9JVXm99JeFeb3ndW0VGBHKvwtPJ8a
# W/WxPYL98GTg8bmC/nGQdli5+wkzIKkT9z3pgDZNWy+PstLq3pBLvDjTsOKmhrO9
# utMqjV/0HH6PVz02t90Do1eXwQ==
